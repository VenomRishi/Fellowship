...
package com.bridgelabz.preparedstatement.batchprocessing.controller;

import java.sql.Connection;
import java.sql.SQLException;

import com.bridgelabz.preparedstatement.batchprocessing.repository.DbConnection;
...
public class BatchProcessingPs {
	...
	private static int[] executeAllQuery() throws SQLException {
		...
		preparedStatement2 = (PreparedStatement) connection.prepareStatement(delete);
		preparedStatement2.addBatch(delete);
